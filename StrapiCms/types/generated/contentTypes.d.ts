...
export interface ApiContact4Contact4 extends Schema.SingleType {
  collectionName: 'contact4s';
  info: {
    singularName: 'contact4';
    pluralName: 'contact4s';
    displayName: 'contact';
    description: '';
  };
  options: {
  ...
  attributes: {
    contactHeader: Attribute.String;
    contactText: Attribute.Text;
    contactEmail: Attribute.Email;
    contactTel: Attribute.Integer;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::contact4.contact4',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::contact4.contact4': ApiContact4Contact4;
